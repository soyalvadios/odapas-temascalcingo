...
export default function HomePage() {
  return (
    <div>
      ...
      {/* ── Barra accesos rápidos — solo móvil ─────────────────────────── */}
      <section className="mobileQuickBar">
        ...
        <Link href="/contacto" className="mqbItem">
          <span className="mqbIcon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 10.6 19.79 19.79 0 01.03 2.02 2 2 0 012 0h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 14.92z"/>
            </svg>
          </span>
      ...
      <section className="container page">
        ...
        {/* Desktop: 3 columnas — Móvil: 2 columnas compactas */}
      ...
      {/* ── Información institucional — compacta en móvil ──────────────── */}
      ...
      {/* ── Noticias destacadas — solo desktop ─────────────────────────── */}
      ...
      <section className="container page pageTight">
        <div className="contactStrip">
          <div className="contactStrip__item">
            ...
            <a href="tel:+527221234567" className="contactStrip__link">722 123 4567</a>
          </div>
          ...
          <div className="contactStrip__divider" />
          <div className="contactStrip__item">
            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#25D366" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z"/>
            </svg>
            <a href="https://wa.me/5212207402561?text=Hola%2C%20necesito%20ayuda." target="_blank" rel="noopener noreferrer" className="contactStrip__link contactStrip__link--wa">
              WhatsApp
            </a>
          </div>
        </div>
